	...
	<div class="fsp-modal-step">
		<div class="fsp-form-group">
			<label class="fsp-is-jb">
				...
				<a href="https://www.fs-poster.com/documentation/fs-poster-schedule-auto-publish-wordpress-posts-to-linkedin" target="_blank" class="fsp-tooltip" data-title="<?php echo esc_html__( 'How to?', 'fs-poster' ); ?>"><i class="far fa-question-circle"></i></a>
			</label>
			<select class="fsp-form-select" id="fspModalAppSelector">
				...
				if ( empty( $fsp_params[ 'applications' ] ) ) { ?>
					<option disabled><?php echo esc_html__('There isn\'t a LinkedIn App!', 'fs-poster'); ?></option>
				<?php } ?>
			</select>
		</div>
	</div>
