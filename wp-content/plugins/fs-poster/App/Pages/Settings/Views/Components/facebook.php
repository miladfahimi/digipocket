...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		<div class="fsp-settings-label-text"><?php echo esc_html__( 'Load my pages', 'fs-poster' ); ?></div>
		<div class="fsp-settings-label-subtext"><?php echo esc_html__( 'Enable to add all your pages to the plugin, pages that you are an admin.', 'fs-poster' ); ?></div>
	</div>
	<div class="fsp-settings-col">
...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		<div class="fsp-settings-label-text"><?php echo esc_html__( 'Load groups', 'fs-poster' ); ?></div>
		<div class="fsp-settings-label-subtext"><?php echo esc_html__( 'Enable to add all your groups to the plugin.', 'fs-poster' ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<div class="fsp-toggle">
...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo __( 'Link card view – share the post with the link;<br>Upload featured image only - upload and share featured image only;<br>Upload all post images - upload and share featured image and all attached images as an album.', 'fs-poster' ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<select name="fs_facebook_posting_type" id="fs_facebook_posting_type" class="fsp-form-select">
			<option value="1" <?php echo Helper::getOption( 'facebook_posting_type', '1' ) == '1' ? 'selected' : ''; ?>><?php echo esc_html__( 'Link card view', 'fs-poster' ); ?></option>
			<option value="2" <?php echo Helper::getOption( 'facebook_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo esc_html__( 'Upload featured image only', 'fs-poster' ); ?></option>
			<option value="3" <?php echo Helper::getOption( 'facebook_posting_type', '1' ) == '3' ? 'selected' : ''; ?>><?php echo esc_html__( 'Upload all post images', 'fs-poster' ); ?></option>
		</select>
	</div>
</div>
