...
<div class="fsp-settings-row">
	...
	<div class="fsp-settings-col">
		<select name="fs_linkedin_posting_type" id="fs_linkedin_posting_type" class="fsp-form-select">
			<option value="1" <?php echo Helper::getOption( 'linkedin_posting_type', '1' ) == '1' ? 'selected' : ''; ?>><?php echo esc_html__( 'Link card view', 'fs-poster' ); ?></option>
			<option value="2" <?php echo Helper::getOption( 'linkedin_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo esc_html__( 'Upload featured image only', 'fs-poster' ); ?></option>
			<option value="3" <?php echo Helper::getOption( 'linkedin_posting_type', '1' ) == '3' ? 'selected' : ''; ?>><?php echo esc_html__( 'Upload all post images', 'fs-poster' ); ?></option>
		</select>
	</div>
</div>
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo esc_html__( 'LinkedIn limits the post content length to a maximum of 1300 characters. By enabling the option, the first 1300 characters of your custom message will be shared; otherwise, the post won\'t be shared because of the limit.', 'fs-poster' ); ?></div>
	</div>
	<div class="fsp-settings-col">
