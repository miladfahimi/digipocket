...
<div class="fsp-settings-row">
	...
	<div class="fsp-settings-col">
		<select name="fs_ok_posting_type" id="fs_ok_posting_type" class="fsp-form-select">
			<option value="1" <?php echo Helper::getOption( 'ok_posting_type', '1' ) == '1' ? 'selected' : ''; ?>><?php echo esc_html__( 'Link card view', 'fs-poster' ); ?></option>
			<option value="2" <?php echo Helper::getOption( 'ok_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo esc_html__( 'Upload featured image only', 'fs-poster' ); ?></option>
			<option value="3" <?php echo Helper::getOption( 'ok_posting_type', '1' ) == '3' ? 'selected' : ''; ?>><?php echo esc_html__( 'Upload all post images', 'fs-poster' ); ?></option>
		</select>
	</div>
</div>
